...
// import { FaUser, FaFileAlt, FaBriefcase, FaBars } from "react-icons/fa";
...
//       {/* Sidebar */}
//       <div
//         className={`d-flex flex-column p-4 vh-100 bg-dark text-white shadow-lg position-fixed ${
...
//           <FaBriefcase className="me-2" /> My Resume
//         </h4>
...
//             as={Link}
//             to="/resume"
//             className={`d-flex align-items-center bg-transparent text-white border-0 p-3 ${
...
//             to="/cover-letter"
//             className={`d-flex align-items-center bg-transparent text-white border-0 p-3 ${
//               location.pathname === "/cover-letter" ? "active-link" : ""
//             }`}
//             style={{ cursor: "pointer" }}
//           >
//             <FaUser className="me-2" /> Cover Letter
//           </ListGroup.Item>
...
//             to="/job-tracker"
//             className={`d-flex align-items-center bg-transparent text-white border-0 p-3 ${
//               location.pathname === "/job-tracker" ? "active-link" : ""
//             }`}
//             style={{ cursor: "pointer" }}
//           >
//             <FaBriefcase className="me-2" /> Job Tracker
//           </ListGroup.Item>
//         </ListGroup>
//       </div>
...
const Sidebar = () => {
  ...
  return (
    <>
      ...
      <Button variant="dark" className="d-lg-none m-3 " onClick={() => setIsOpen(!isOpen)}>
        <FaBars size={20} />
      </Button>
      ...
      <div className={`sidebar ${isOpen ? "open" : ""}`}>
        ...
        <ListGroup variant="flush">
          {[
            ...
            { path: "/cover-letter", icon: <FaUser />, label: "Cover Letter" },
            ...
            {(
              <div className={`left-menu mt-30 ${isOpen ? 'open' : ''}`}>
                <div id="sidebar-menu">
