...
// //     try {
// //       const response = await axios.get(`${apiUrl}/applicant-image/getphoto/${userId}`, {
...
// //       setInitialPhoto(binaryArray);
     
// //     } catch (error) {
// //       console.error('Error fetching photo:', error);
// //       alert('Please upload your latest photo to proceed to the test.');
// //     }
// //   };
// //   const BeginTest = async () => {
// //   // Check if full screen is active; if not, request it.
// //   if (!document.fullscreenElement) {
// //     enterFullScreen();
// //     // Wait briefly to allow full screen mode to engage (adjust timeout as needed)
// //     await new Promise((resolve) => setTimeout(resolve, 1000));
// //     if (!document.fullscreenElement) {
// //       showModal("Please enable full screen mode to start the test.");
// //       return; // Abort starting the test if full screen is not active
// //     }
// //   }
...
// //   if (!cameraAvailable) {
// //     showModal("Camera not available or permission denied. Test cannot be started.");
// //     return; // Abort test startup if camera access is not granted
// //   }
 
// //   // Both conditions are satisfied: start the test.
// //   startTest();
// // };
...
// //         console.log('Registered face descriptor set:', descriptor);
// //         handleFaceValidation(true);
// //       } else {
// //         handleFaceValidation(false);
// //       }
// //     } catch (error) {
...
// //   const handleFaceValidation = (isValid) => {
// //     if (isValid) {
// //       if(!testStarted){
// //       showModal('Valid photo, proceed to the test.');
// //       }
// //       setCurrentPage('startVideo'); // Set to startVideo to trigger video and face detection
// //     } else {
// //       showModal('Invalid photo, please upload a valid photo to proceed to the test.');
// //     }
// //   };
...
// //       })
// //       .catch((err) => {
// //         console.error('Error starting video source:', err);
// //         alert('Could not start the video source. Please check your camera permissions and try again.');
// //       });
// //   };
...
// //       console.error('Registered face descriptor is not set');
// //       return;
// //     }
...
// //         if (!validateFace(currentDescriptor)) {
// //           setFaceMismatchWarnings(prevWarnings => {
// //             if (prevWarnings + 1 >= 3) {
// //               setTimeout(()=>showModal('Face does not match registered face. Test is terminated.'),[]);
// //               stopVideo();
// //               handleConfirmExit();
// //               handleTestCompletion();
// //               setCurrentPage('instructions'); // Reset to instructions page
// //               return 0; // Reset warnings
// //             } else {
// //               showModal(`Face mismatch warning ${prevWarnings + 1} of 3.`);
// //               return prevWarnings + 1;
// //             }
// //           });
// //         } else if (detections.length > 1) {
// //           setMultipleFacesWarnings(prevWarnings => {
// //             if (prevWarnings + 1 >= 3) {
             
// //               setTimeout(()=>showModal('Multiple faces detected. Test is terminated.'),2000);
// //               stopVideo();
// //               handleConfirmExit();
// //               handleTestCompletion();
// //               setCurrentPage('instructions'); // Reset to instructions page
// //               return 0; // Reset warnings
// //             } else {
// //               showModal(`Multiple faces warning ${prevWarnings + 1} of 3.`);
// //               return prevWarnings + 1;
// //             }
// //           });
// //         } else {
// //           // Face matches and no multiple faces detected
// //           if (!testStarted) {
// //             showModal('Face detected. Test will start shortly.');
// //             setTestStarted(true);
// //             setCurrentPage('test');
// //             setFaceMismatchWarnings(0);
// //             setMultipleFacesWarnings(0);
// //             console.log('Test started');
// //           }
// //         }
// //       } else {
// //         showModal('No face detected. Please center your face in the camera.');
// //       }
// //     } catch (error) {
// //       console.error('Error detecting faces:', error);
// //       showModal('Error detecting faces. Please try again.');
// //     }
// //   };
 
 
// //   const validateFace = (descriptor) => {
// //     if (!registeredFaceDescriptor || !descriptor) {
// //       console.error('Face descriptors are not properly initialized');
// //       return false;
// //     }
// //     const distance = faceapi.euclideanDistance(registeredFaceDescriptor, descriptor);
// //     return distance < 0.6; // Adjust threshold as necessary
// //   };
 
// //   useEffect(() => {
// //     if (currentPage === 'startVideo' || currentPage === 'test') {
// //       startVideo();
// //       const intervalId = setInterval(detectFaces, 5000); // Detect faces every second
// //       faceDetectionIntervalId.current = intervalId;
